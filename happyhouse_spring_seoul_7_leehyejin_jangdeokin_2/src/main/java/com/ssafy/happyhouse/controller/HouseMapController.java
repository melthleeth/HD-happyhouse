...
//			}
//		}//dong
//		else if("searchByKeyword".equals(act)) {
...
//			try {
//				if (type.equals("apt"))
//					list = HouseMapServiceImpl.getHouseMapService().getAptInfo(detailedSearch);
//				else
//					list = HouseMapServiceImpl.getHouseMapService().getDongInfo(detailedSearch);
//				
//				for(HouseDealDto dto : list) {
//					JSONObject obj = new JSONObject();
//					obj.put("no", dto.getNo());
